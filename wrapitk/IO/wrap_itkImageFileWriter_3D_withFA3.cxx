/*=========================================================================
  ...
  Module:    $RCSfile: wrap_itkImageFileWriter_3D_withFA3.cxx,v $
  Language:  C++
...
namespace _cable_
{
  ...
  namespace wrappers
  {
    ...
    // naughty modifications by charl
    typedef itk::FixedArray< float, 3 > FA3;
    typedef itk::Image< FA3, 3 > imageFA3;
    ITK_WRAP_OBJECT1(ImageFileWriter, imageFA3, itkImageFileWriterFA3);
  }
}
